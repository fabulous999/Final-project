...
(function (scenes) {
    ...
    var level4 = (function (_super) {
         ...
         * @return void
         */
        level4.prototype._setupCanvas = function () {
         ...
         * @returns void
         */
        level4.prototype._initialize = function () {
        ...
        /**
          ...
          * @return void
          */
        level4.prototype.addSpotLight = function () {
            // Spot Light
        ...
        level4.prototype.addAmbientLight = function () {
            // Ambient Light
        ...
        level4.prototype.level4 = function () {
            ...
            for (var i = 0; i < 10; i++) {
                ...
                this.obstacle.position.set(randomIntInc((i * 3), (i * 4)), randomIntInc((i * 3), (i * 4)), randomIntInc((i * 3), (i * 4)));
                ...
                if (i == 9) {
                    ...
                    this.goal.name = "goal";
                    this.goal.position.set(randomIntInc((i * 2), (i * 3)), randomIntInc((i * 2), (i * 3)), randomIntInc((i * 2), (i * 3)));
                    this.add(this.goal);
                }
            }
        };
         ...
         * @return void
         */
        level4.prototype.addPlayer = function () {
            // Player Object
        ...
        level4.prototype.AmbientLight = function () {
            this.ambientLight = new AmbientLight(0x808080);
            this.add(this.ambientLight);
        };
        /*
         ...
         * @return void
         */
        level4.prototype.pointerLockChange = function (event) {
         ...
         * @return void
         */
        level4.prototype.pointerLockError = function (event) {
            this.instructions.style.display = '';
         ...
         * @return void
         */
        level4.prototype.checkControls = function () {
         ...
         * @return void
         */
        level4.prototype.cameraLook = function () {
         ...
         * @return void
         */
        level4.prototype.resize = function () {
